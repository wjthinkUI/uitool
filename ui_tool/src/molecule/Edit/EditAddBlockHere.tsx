...
export const EditAddBlockHereTop = ({ onClick }: AddBlock) => {
    ...
    return (
        <div className="absolute w-[100%] hidden flex-col items-center group-hover:flex z-50">
...
export const EditAddBlockHereBottom = ({ onClick }: AddBlock) => {
    ...
    return (
        <div className="absolute w-[100%] bottom-0 hidden flex-col items-center group-hover:flex z-50">
